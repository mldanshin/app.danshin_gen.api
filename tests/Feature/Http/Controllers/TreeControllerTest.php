...
final class TreeControllerTest extends TestCase
{
    ...
    {
        $response = $this->getJson(route('tree.model', ['id' => $personId]).$request, $this->getHeaderRelativeSsoToken());
    ...
    {
        $response = $this->getJson(route('tree.model', ['id' => 1]).$request, $this->getHeaderRelativeSsoToken());
    ...
    {
        $response = $this->get(route('tree.model', ['id' => $personId]).$request, $this->getHeaderRelativeSsoToken());
    ...
    public function test_get_model403(): void
    {
        $response = $this->getJson(route('tree.model', ['id' => 1]), $this->getHeaderUserSsoToken());
    ...
    {
        $response = $this->getJson(route('tree.image', ['id' => $personId]).$request, $this->getHeaderRelativeSsoToken());
    ...
    {
        $response = $this->getJson(route('tree.image', ['id' => 1]).$request, $this->getHeaderRelativeSsoToken());
        $response->assertStatus(422);
    }
    ...
    {
        $response = $this->get(route('tree.image', ['id' => $personId]).$request, $this->getHeaderRelativeSsoToken());
        $response->assertStatus(404);
    }
    ...
    public function test_get_image403(): void
    {
        $response = $this->getJson(route('tree.image', ['id' => 1]), $this->getHeaderUserSsoToken());
        $response->assertStatus(403);
    }
    ...
    {
        $response = $this->get(
            route('tree.image_interactive', ['id' => $personId]).$request, $this->getHeaderRelativeSsoToken()
        );
        $response->assertStatus(200);
        $response->assertSee([
    ...
    public function test_image_interactive422(string $request): void
    {
        $response = $this->getJson(
            route('tree.image_interactive', ['id' => 3]).$request, $this->getHeaderRelativeSsoToken()
        );
        $response->assertStatus(422);
    }
    ...
    public function test_image_interactive404(string $personId, string $request): void
    {
        ...
        $response = $this->get(
            route('tree.image_interactive', ['id' => $personId]).$request.$params, $this->getHeaderRelativeSsoToken()
        );
        $response->assertStatus(404);
    }
    ...
    public function test_get_image_interactive403(): void
    {
        $response = $this->getJson(route('tree.image_interactive', ['id' => 1]), $this->getHeaderUserSsoToken());
        $response->assertStatus(403);
    }
    ...
    {
        $response = $this->getJson(route('tree.toggle', ['id' => $personId]).$request, $this->getHeaderRelativeSsoToken());
        $response->assertStatus(200)->assertJson($expected);
    }
    ...
    {
        $response = $this->get(route('tree.toggle', ['id' => $personId]).$request, $this->getHeaderRelativeSsoToken());
        $response->assertStatus(404);
    }
    ...
    {
        $response = $this->getJson(route('tree.toggle', ['id' => 1]).$request, $this->getHeaderRelativeSsoToken());
        $response->assertStatus(422);
    }
