...
final class MarriageControllerTest extends TestCase
{
    ...
    public function test_role_all200(): void
    {
        ...
        $response = $this->getJson(route('marriage.roles.all'), $this->getHeaderAdminSsoToken());
    ...
    {
        $response = $this->getJson(route('marriage.roles.all'), $this->getHeaderRelativeSsoToken());
