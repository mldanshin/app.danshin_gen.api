...
final class PersonEditControllerTest extends TestCase
{
    ...
    public function test_edit200(string $id, callable $expected): void
    {
        ...
        $response = $this->getJson(route('person.edit', ['person' => $id]), $this->getHeaderAdminSsoToken());
    ...
    {
        $response = $this->getJson(route('person.edit', ['person' => '1']), $this->getHeaderRelativeSsoToken());
