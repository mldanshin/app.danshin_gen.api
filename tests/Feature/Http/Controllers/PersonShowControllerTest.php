...
final class PersonShowControllerTest extends TestCase
{
    ...
    public function test_show200(int $person, string $request, callable $expected): void
    {
        ...
        $response = $this->getJson(
            route('person.show', ['id' => $person]).$request, $this->getHeaderRelativeSsoToken()
        );
    ...
    public function test_show403(): void
    {
        $response = $this->getJson(route('person.show', ['id' => 1]), $this->getHeaderUserSsoToken());
    ...
    public function test_show404(?string $id, string $request): void
    {
        ...
        $response = $this->getJson(route('person.show', ['id' => $id]).$request, $this->getHeaderRelativeSsoToken());
