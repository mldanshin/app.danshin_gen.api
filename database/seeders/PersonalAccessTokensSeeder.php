...
class PersonalAccessTokensSeeder extends Seeder
{
    ...
    {
        $this->create("App\Models\Eloquent\User", 4, 'admintoken', '4pawb2A0kxKSQuUAMtbCjH6n3CBbAj8snUnFU0Zs', ['ADMIN']);
        $this->create("App\Models\Eloquent\User", 5, 'usertoken', 'GQNzZM0tHNTPtaxEv56832MnCAXtmHzt7kNPtgh8', ['USER']);
        $this->create("App\Models\Eloquent\User", 4, 'x-site', 'AZgjIm6DPPuGywFSpEMZLVtKUwTsuj87pCLng4cw', ['ADMIN']);
    }
